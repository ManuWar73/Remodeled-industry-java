package remodeledindustry.abilities;
...
public class BulletOnDamageAbility extends Ability {
    /** Lightning damage */
    ...
    public Sound shootSound = Sounds.explosionbig;
    BulletType reactionExplosive = new BasicBulletType() {{
    ...
    BulletOnDamageAbility(){}

    public BulletOnDamageAbility(float damage, int length, float chance, float y, float minSpeed, float maxSpeed, Color color, String heatRegion){
        this.damage = damage;
        this.y = y;
        this.heatRegion = heatRegion;
    }

    public BulletOnDamageAbility(float damage, int length, float chance, float y, float minSpeed, float maxSpeed, Color color){
        this.damage = damage;
        this.length = length;
        this.chance = chance;
        this.y = y;
    ...
    public void update(Unit unit){
        ...
        if(Mathf.chance(Time.delta * chance * scl)){
            ...
            shootSound.at(x, y);
            reactionExplosive.create(unit, unit.team, damage, x + unit.vel.x, y + unit.vel.y, unit.rotation, length);
        }
    }
